...
def convert_blip2_checkpoint(model_name, pytorch_dump_folder_path=None, push_to_hub=False):
    ...
    model_name_to_original = {
        "blip_2-opt-2.7b": ("blip2_opt", "pretrain_opt2.7b"),
        "blip_2-opt-6.7b": ("blip2_opt", "pretrain_opt6.7b"),
        "blip_2-opt-2.7b-coco": ("blip2_opt", "caption_coco_opt2.7b"),
        "blip_2-opt-6.7b-coco": ("blip2_opt", "caption_coco_opt6.7b"),
        "blip_2-flan-t5-xl": ("blip2_t5", "pretrain_flant5xl"),
        "blip_2-flan-t5-xl-coco": ("blip2_t5", "caption_coco_flant5xl"),
        "blip_2-flan-t5-xxl": ("blip2_t5", "pretrain_flant5xxl"),
    }
...
if __name__ == "__main__":
    ...
    choices = [
        "blip_2-opt-2.7b",
        "blip_2-opt-6.7b",
        "blip_2-opt-2.7b-coco",
        "blip_2-opt-6.7b-coco",
        "blip_2-flan-t5-xl",
        "blip_2-flan-t5-xl-coco",
        "blip_2-flan-t5-xxl",
    ]
    parser.add_argument(
        "--model_name",
        default="blip_2-opt-2.7b",
        choices=choices,
        type=str,

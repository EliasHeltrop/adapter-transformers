...
BLIP_2_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "salesforce/blip_2-opt-2.7b": "https://huggingface.co/salesforce/blip2-opt-2.7b/resolve/main/config.json",
}
...
class Blip2VisionConfig(PretrainedConfig):
    ...
    [Salesforce/blip_2-opt-2.7b](https://huggingface.co/Salesforce/blip2-opt-2.7b) architecture.
    ...
    >>> # Initializing a Blip2VisionConfig with Salesforce/blip_2-opt-2.7b style configuration
    >>> configuration = Blip2VisionConfig()

    >>> # Initializing a Blip2VisionModel (with random weights) from the Salesforce/blip_2-opt-2.7b style configuration
...
class Blip2QFormerConfig(PretrainedConfig):
    ...
    [Salesforce/blip_2-opt-2.7b](https://huggingface.co/Salesforce/blip2-opt-2.7b) architecture. Configuration objects
    ...
    >>> # Initializing a BLIP-2 Salesforce/blip_2-opt-2.7b style configuration
    >>> configuration = Blip2QFormerConfig()

    >>> # Initializing a model (with random weights) from the Salesforce/blip_2-opt-2.7b style configuration
...
class Blip2Config(PretrainedConfig):
    ...
    that of the BLIP-2 [Salesforce/blip_2-opt-2.7b](https://huggingface.co/Salesforce/blip2-opt-2.7b) architecture.
    ...
    >>> # Initializing a Blip2Config with Salesforce/blip_2-opt-2.7b style configuration
    >>> configuration = Blip2Config()

    >>> # Initializing a Blip2ForConditionalGeneration (with random weights) from the Salesforce/blip_2-opt-2.7b style configuration

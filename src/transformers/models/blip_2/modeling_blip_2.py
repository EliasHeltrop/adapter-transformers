...
_CHECKPOINT_FOR_DOC = "Salesforce/blip_2-opt-2.7b"

BLIP_2_PRETRAINED_MODEL_ARCHIVE_LIST = [
    "Salesforce/blip_2-opt-2.7b",
...
class Blip2Model(Blip2PreTrainedModel):
    ...
    def get_text_features(
        ...
        >>> model = Blip2Model.from_pretrained("Salesforce/blip_2-opt-2.7b")

        >>> tokenizer = AutoTokenizer.from_pretrained("Salesforce/blip_2-opt-2.7b")
    ...
    def get_image_features(
        ...
        >>> processor = AutoProcessor.from_pretrained("Salesforce/blip_2-opt-2.7b")
    ...
    def get_qformer_features(
        ...
        >>> processor = Blip2Processor.from_pretrained("Salesforce/blip_2-opt-2.7b")
        >>> model = Blip2Model.from_pretrained("Salesforce/blip_2-opt-2.7b")
    ...
    def forward(
        ...
        >>> processor = Blip2Processor.from_pretrained("Salesforce/blip_2-opt-2.7b")
        >>> model = Blip2Model.from_pretrained("Salesforce/blip_2-opt-2.7b", torch_dtype=torch.float16)
...
class Blip2ForConditionalGeneration(Blip2PreTrainedModel):
    ...
    def forward(
        ...
        ...     "Salesforce/blip_2-opt-2.7b", load_in_8bit=True, device_map={"": 0}, torch_dtype=torch.float16
        ...
        ```python
        >>> model = Blip2ForConditionalGeneration.from_pretrained(
        ...     "Salesforce/blip_2-opt-2.7b", load_in_8bit=True, device_map={"": 0}, torch_dtype=torch.bfloat16
        ... )  # doctest: +IGNORE_RESULT
